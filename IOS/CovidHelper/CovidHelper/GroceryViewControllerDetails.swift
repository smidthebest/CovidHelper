//
//  GroceryViewControllerDetails.swift
//  CovidHelper
//
...
class GroceryViewControllerDetails : UIViewController
{
    ...
    @IBAction func addToCart(_ sender: Any)
    {
        ...
        UIView.animate(withDuration: 1.0, delay: 0.0, options: .curveEaseOut, animations: {
            ...
            //Else, if ordered groeceries same store. Existing cart
            if cartStore.id == currentStore.id {
                ...
                if let itemIndex = itemIndex {
                    ...
                    // User want to add groceries don't exist in cart
                    Cart.currentCart.items.append(cartItem)
